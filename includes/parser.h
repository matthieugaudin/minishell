...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/09 18:33:29 by mgaudin           #+#    #+#             */
/*   Updated: 2025/04/09 18:33:30 by mgaudin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*============LINKED LIST===========*/
t_file	*new_file(t_data *data, char *name,
			enum e_token type, bool hdoc_quotes);
